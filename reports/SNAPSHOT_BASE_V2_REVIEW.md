...
- Workspace 入口：`SnapshotBaseV2.slnx`
- 已加载 Project：3 / 3
- 已分析文件：13
- 确定 Key 的 Feature Flag：7
- Key 尚未确定的表达式实体：3
- Reference：19（Direct 4 / Indirect 15）
...
- Coverage：发现 3 个 Project，加载 3 个，失败 0 个；分析 13 个文件。
- Unresolved：9 项。
  - `UNBOUND_PARAMETER`：4
  - `UNRESOLVED_EXPRESSION`：5
- Diagnostic：0 项。

_本报告实际读取并核对了 5 个源码文件；未写入绝对路径、扫描时间或机器信息。_
