...
- Key 尚未确定的表达式实体：9
- Reference：54（Direct 6 / Indirect 48）
...
| `acceptance.di.constructor` | BOOLEAN/VALUE | true | 1 | DEFINITE |
...
| `acceptance.pr.checkout-banner` | BOOLEAN/VALUE | false | 1 | DEFINITE |
| `acceptance.pr.get-value-v2` | BOOLEAN/VALUE | false | 1 | DEFINITE |
...
[`src/SnapshotScan.DependencyInjection/DependencyInjectionComposition.cs:53`](<../src/SnapshotScan.DependencyInjection/DependencyInjectionComposition.cs#L53-L54>)
...
- OpenFeature API：`M:OpenFeature.IFeatureClient.GetBooleanValueAsync(System.String,System.Boolean,OpenFeature.Model.EvaluationContext,OpenFeature.Model.FlagEvaluationOptions,System.Threading.CancellationToken)`（BOOLEAN / VALUE）
- Key / 默认值：`acceptance.di.constructor` / `true`
...
- 调用位置：[`src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs:13`](<../src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs#L13>)
- 所在 Symbol：`SnapshotScan.DependencyInjection.PullRequestCheckoutBanner.GetBannerAsync()`
- OpenFeature API：`M:OpenFeature.IFeatureClient.GetBooleanValueAsync(System.String,System.Boolean,OpenFeature.Model.EvaluationContext,OpenFeature.Model.FlagEvaluationOptions,System.Threading.CancellationToken)`（BOOLEAN / VALUE）
- Key / 默认值：`acceptance.pr.checkout-banner` / `false`

#### 调用、Wrapper 与真实 Evaluation

##### Evaluation 所在代码 — `SnapshotScan.DependencyInjection.PullRequestCheckoutBanner.GetBannerAsync()`

[`src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs:11`](<../src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs#L11-L20>)
...
[`src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs:13`](<../src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs#L13-L15>)
...
[`src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs:17`](<../src/SnapshotScan.DependencyInjection/PullRequestCheckoutBanner.cs#L17-L19>)
...
- OpenFeature API：`M:OpenFeature.IFeatureClient.GetBooleanValueAsync(System.String,System.Boolean,OpenFeature.Model.EvaluationContext,OpenFeature.Model.FlagEvaluationOptions,System.Threading.CancellationToken)`（BOOLEAN / VALUE）
- Key / 默认值：`acceptance.pr.get-value-v2` / `false`
...
- 最终值证据：`key: acceptance.pr.get-value-v2`
- 配置来源文件：[`src/SnapshotScan.Configuration/appsettings.json`](<../src/SnapshotScan.Configuration/appsettings.json>)
...
- Coverage：发现 6 个 Project，加载 6 个，失败 0 个；分析 31 个文件。
- Unresolved：38 项。
...
_本报告实际读取并核对了 16 个源码文件；未写入绝对路径、扫描时间或机器信息。_
